...
public class Register extends JFrame {
    ...
    private JTextField txtEmail, txtPassword, txtName, txtSurname, txtAge;
    ...
    public void buildRegisterGUI(){
        ...
        JPanel registrationForm = new JPanel(new GridLayout(15, 5));
        ...
        registrationForm.add(txtAge = new JTextField(3));  
        registrationForm.add(new JLabel(" "));
        registrationForm.add(new JLabel(" "));
        ...
        registrationForm.add(lblPassword = new JLabel("Input Password: "));
        registrationForm.add(txtPassword = new JTextField(15));
        registrationForm.add(new JLabel(" "));
        registrationForm.add(new JLabel(" "));
    ...
    public void addUser() throws GeneralSecurityException, GeneralSecurityException{
